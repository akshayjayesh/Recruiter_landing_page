...
export default function AIWorkflowSection() {
  ...
  return (
    <section id="ai-workflow" className="py-24 px-6 md:px-8 bg-background relative">
      <div className="max-w-7xl mx-auto space-y-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                ...
                return (
                  <div
                    ...
                    className={`p-3.5 border rounded-sm transition-all duration-300 cursor-pointer flex items-start gap-4 ${
                      isActive
                        ? "bg-card/70 border-primary/45"
                        : "bg-muted/20 border-border hover:border-border"
                    }`}
                  >
                    <span className={`font-mono text-xs ${isActive ? "text-primary font-bold" : "text-muted-foreground"}`}>
                      {step.code}
                    </span>
                    <div className="space-y-1">
                      <div className="flex items-center gap-2">
                        <span className={`font-mono text-xs font-semibold ${isActive ? "text-foreground" : "text-foreground"}`}>
                          {step.name}
                        </span>
                      ...
                      {isActive && (
                        <motion.p
                          ...
                          className="text-muted-foreground text-xs leading-relaxed pt-1.5"
                        >
                          {step.desc}
                        </motion.p>
                      )}
          ...
          <div className="lg:col-span-6">
            <GlassCard className="bg-card/80 border-border p-6" glowEffect>
              ...
              <div className="space-y-4 font-mono text-[10px] min-h-[250px] flex flex-col justify-center">
                ...
                {activeStep === 0 && (
                  <motion.div initial={{ opacity: 0, x: 10 }} animate={{ opacity: 1, x: 0 }} className="space-y-3">
                    ...
                    <div className="bg-card/50 border border-border p-3 rounded-sm">
                      ...
                      <div className="space-y-1">
                        <div className="text-[9px] text-foreground flex justify-between"><span className="text-muted-foreground">Role:</span> Senior Go Engineer</div>
                        <div className="text-[9px] text-foreground flex justify-between"><span className="text-muted-foreground">Stack:</span> Go, Kubernetes</div>
                      </div>
                    </div>
                    <div className="flex justify-center"><ArrowDown className="w-4 h-4 text-primary/50" /></div>
                    <div className="bg-card/50 border border-border p-3 rounded-sm">
                ...
                {activeStep === 1 && (
                  <motion.div initial={{ opacity: 0, x: 10 }} animate={{ opacity: 1, x: 0 }} className="space-y-3">
                    <div className="bg-card/50 border border-border p-3 rounded-sm">
                      ...
                      <div className="text-muted-foreground text-[9px]">Loading parameter tokens...</div>
                    </div>
                    ...
                    <div className="bg-primary/5 border border-primary/20 p-3 rounded-sm">
                      ...
                      <div className="text-[9px] text-foreground">Evaluating standard compensations and duties for 'Senior Go Engineer'...</div>
                    </div>
                    <div className="flex justify-center"><ArrowDown className="w-4 h-4 text-primary/50" /></div>
                    <div className="bg-card/50 border border-border p-3 rounded-sm">
                  ...
                  <motion.div initial={{ opacity: 0, x: 10 }} animate={{ opacity: 1, x: 0 }} className="space-y-3">
                    <div className="bg-card/50 border border-border p-3 rounded-sm">
                      ...
                      <div className="flex gap-2 flex-wrap">
                        <span className="px-2 py-0.5 bg-muted rounded-sm text-[9px]">Golang</span>
                        <span className="px-2 py-0.5 bg-muted rounded-sm text-[9px]">Kubernetes</span>
                        <span className="px-2 py-0.5 bg-muted rounded-sm text-[9px]">AWS</span>
                      </div>
                    </div>
                    <div className="flex justify-center"><ArrowDown className="w-4 h-4 text-primary/50" /></div>
                    <div className="bg-card/50 border border-border p-3 rounded-sm space-y-2">
                      ...
                      <div className="flex justify-between items-center text-xs">
                        ...
                        <span className="text-muted-foreground">0.5 (Bonus)</span>
                      </div>
                    </div>
                    <div className="flex justify-center"><ArrowDown className="w-4 h-4 text-primary/50" /></div>
                ...
                {activeStep === 3 && (
                  <motion.div initial={{ opacity: 0, x: 10 }} animate={{ opacity: 1, x: 0 }} className="space-y-3">
                    <div className="bg-card/50 border border-border p-3 rounded-sm flex items-center gap-3">
                    ...
                    <div className="bg-card/50 border border-border p-3 rounded-sm">
                      ...
                      <div className="space-y-2 pl-6">
                        <div className="text-[10px] text-foreground border-l-2 border-[#16A34A]/50 pl-2">Experience: 5 years</div>
                        <div className="text-[10px] text-foreground border-l-2 border-[#16A34A]/50 pl-2">Education: BS Computer Science</div>
                        <div className="text-[10px] text-foreground border-l-2 border-[#16A34A]/50 pl-2">Skills: Go, Docker, K8s, GCP</div>
                      </div>
                    </div>
                  </motion.div>
                )}
                ...
                {activeStep === 4 && (
                  <motion.div initial={{ opacity: 0, x: 10 }} animate={{ opacity: 1, x: 0 }} className="space-y-3">
                    <div className="bg-card/50 border border-border p-3 rounded-sm flex justify-between items-center">
                      ...
                      <div className="text-[9px] text-muted-foreground">Job_Vector vs Candidate_Vector</div>
                    </div>
                    <div className="flex justify-center"><ArrowDown className="w-4 h-4 text-primary/50" /></div>
                    <div className="bg-card/50 border border-border p-3 rounded-sm">
                      ...
                      <div className="h-1.5 bg-muted rounded-full w-full overflow-hidden mt-2 relative">
                    ...
                    <div className="bg-primary/5 border border-primary/20 p-4 rounded-sm flex flex-col items-center text-center space-y-2">
                      ...
                      <div className="text-2xl text-foreground font-bold mt-1">98%</div>
                      <p className="text-muted-foreground text-[8px] uppercase tracking-wider">High Match Probability</p>
                    </div>
                  </motion.div>
                )}
                ...
                {activeStep === 5 && (
                  <motion.div initial={{ opacity: 0, x: 10 }} animate={{ opacity: 1, x: 0 }} className="space-y-3">
                    <div className="bg-card/50 border border-border p-3 rounded-sm">
                      ...
                      <div className="text-[9px] text-muted-foreground">Candidate scored low on 'AWS deployment experience'</div>
                    </div>
                    <div className="flex justify-center"><ArrowDown className="w-4 h-4 text-primary/50" /></div>
                    <div className="bg-primary/5 border border-primary/20 p-3 rounded-sm flex items-center gap-3">
                      <span className="w-4 h-4 rounded-full bg-primary/20 flex items-center justify-center text-primary font-bold text-[8px]">2</span>
                    ...
                    <div className="bg-card/50 border border-border p-3 rounded-sm space-y-2">
                      ...
                      <div className="text-[10px] text-foreground bg-muted/80 p-2.5 rounded border border-border">
        ...
        <div className="border-t border-border pt-10">
          <div className="flex flex-wrap gap-3 justify-center">
            {badges.map((badge) => (
              <span
                key={badge}
                className="px-3 py-1 bg-muted border border-border text-muted-foreground font-mono text-[9px] uppercase tracking-wider rounded-sm select-none"
              >
                {badge}
              </span>
            ))}
